# T4 BinaryAttention run

- 目的：YOLO11m BinaryAttention accuracy/fidelity experiment。
- 相對前一 variant：`T3`；本 run 改動為 `ResidualDualFullBasisAttention` / `dual`。
...
- config hash：`f7a72545e1fb49f221baadc26a27a70ed4e0ab1df2da35579d258b2855c8f6a5`。
