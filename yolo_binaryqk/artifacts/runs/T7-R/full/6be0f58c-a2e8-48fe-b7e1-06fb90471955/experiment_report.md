...
- config hash：`fff3546ce2a21ef467f89ff4f2418dd5a4d0cda0ab6fc1001af1ad460f04c031`。

## Attention / loss

- QK：`dual`；QAT：`True`；bias：`decomposed_2d`。
- quantization contract：`{"bias_initialization": "zeros", "bias_parameterization": "axis_decomposed_relative_position", "p8_scale": "none", "qk_scale": "residual_basis_channel_per_token", "v8_scale": "none"}`。
...
- mAP50: 0.67402
- mAP75: None
- coco_mAP50_95: 0.5116580257417623
- coco_mAP50: 0.681070727623415
- coco_mAP75: 0.5560200887216787
- mAPs: 0.3321834393916519
- mAPm: 0.5651192190362756
- mAPl: 0.6701448441319784
