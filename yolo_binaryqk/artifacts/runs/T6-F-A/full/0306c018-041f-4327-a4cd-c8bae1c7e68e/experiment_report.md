...
- config hash：`8db41a1b4b89d504a6eb3638fd880c85a684d0e92c66f05a5cfa2138491382bf`。
...
- KD：`feature+attention`，components=`['feature', 'attention']`。
