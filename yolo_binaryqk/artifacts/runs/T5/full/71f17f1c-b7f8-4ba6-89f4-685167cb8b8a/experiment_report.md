# T5 BinaryAttention run

- 目的：YOLO11m BinaryAttention accuracy/fidelity experiment。
- 相對前一 variant：`T4`；本 run 改動為 `ResidualDualMatchedBasisAttention` / `dual`。
...
- config hash：`234d10312d085931b3132df6dd273fa552207abe9756a9343b0c67f8e2060985`。
