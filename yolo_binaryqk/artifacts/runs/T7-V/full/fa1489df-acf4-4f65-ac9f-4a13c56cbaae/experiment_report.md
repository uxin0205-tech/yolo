...
- config hash：`2effb19317703f4c3e071235be7bdf0170dee51781c5b72574f13a8eaf59aeb5`。

## Attention / loss

- QK：`dual`；QAT：`True`；bias：`dense_2d`。
- quantization contract：`{"bias_initialization": "truncated_normal_std_0.02", "bias_parameterization": "full_2d_relative_position", "p8_scale": "none", "qk_scale": "residual_basis_channel_per_token", "v8_scale": "max_abs_token_per_sample_head_channel"}`。
...
- mAP50: 0.6728
- mAP75: None
- coco_mAP50_95: 0.510824175564245
- coco_mAP50: 0.6798102976787486
- coco_mAP75: 0.5544890423714078
- mAPs: 0.3288208800577662
- mAPm: 0.5641468125339176
- mAPl: 0.6693125204625557
