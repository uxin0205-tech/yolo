...
- config hash：`ebcc5bdf1ec83097ffd4c4c2fed084eb562f6c841ac8fe1553f6c80f0095cf96`。

## Attention / loss

- QK：`dual`；QAT：`True`；bias：`dense_2d`。
- quantization contract：`{"bias_initialization": "truncated_normal_std_0.02", "bias_parameterization": "full_2d_relative_position", "p8_scale": "static_unsigned_1_over_255", "qk_scale": "residual_basis_channel_per_token", "v8_scale": "none"}`。
...
- mAP50: 0.67368
- mAP75: None
- coco_mAP50_95: 0.5114337246990875
- coco_mAP50: 0.6808117484475177
- coco_mAP75: 0.5556553405089381
- mAPs: 0.33122223134129114
- mAPm: 0.5634009693338468
- mAPl: 0.6700689914064053
