...
def main():
    ...
    baseline = ROOT/'experiments/kd/dual_task_v1/artifacts/student-baseline-v1.json'
    head = ROOT/'experiments/kd/pose_focus_v1/artifacts/direct-kd-result-v1.json'
    mix = ROOT/'experiments/inference/pose_branch_v1/artifacts/branch-v2/metrics.json'
    route = ROOT/'experiments/inference/routing_v1/artifacts/one2many-v1/summary.json'
    cases = [
