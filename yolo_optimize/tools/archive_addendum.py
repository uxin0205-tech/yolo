...
def main():
    ...
    sources = {}
    for rel in ('reports/consolidated-20260911', 'experiments/inference/routing_v1', 'docs/worklogs'):
        for x in walk(ROOT / rel):
            sources[x] = Path('snapshot/optimize') / x.relative_to(ROOT)
    for rel in ('README.md', 'tools/archive_research.py', 'tools/archive_addendum.py',
                'experiments/combine/bridge_v1/plan.json', 'experiments/combine/bridge_v1/README.md',
                'experiments/kd/pose_focus_v1/README.md', 'experiments/kd/dual_task_v1/README.md',
                'reports/direction1/README.md', 'experiments/studies/pre-fusion-full35-b100/README.md'):
    ...
    events = ROOT/'experiments/combine/artifacts/logs/pose-routing-one2many-v1.events.jsonl'
