...
舊[`V4 W8報告`](2026-09-03-v4-qsilu-backbone-early-w8-search-validation.md)仍保留原始`mAP50–95/-0.04`判定，不能被原地改寫。本輪[`mAP50 re-gate`](../../artifacts/reports/v5-qsilu-backbone-early-w8-map50-regate-v1.json)直接驗證舊總報告與三個raw metrics檔的SHA-256，沒有重跑或挑選不同資料。
