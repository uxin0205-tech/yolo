...
class PWLExperimentRunner:
    ...
    def compare(self, request: EvaluationRequest, *, score_run_dir: Path) -> QueueResult:
        ...
        score_payload = json.loads((refreshed_score_dir / "metrics" / "score-analysis.json").read_text())
            ...
            rows.append(
                {
                    ...
                    "endpoint_storage_bits": (0 if method == "Float PWL" else selected.endpoint_storage_bits),
                }
            )
