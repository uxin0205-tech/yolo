...
class Detect(nn.Module):
    ...
    def __init__(self, nc: int = 80, reg_max=16, end2end=False, ch: tuple = (), cls_channels: int | None = None):
        ...
        Args:
            ...
            cls_channels (int, optional): Fixed classification tower width. Defaults to deriving it from the first input.
        """
        super().__init__()
        ...
        c3 = cls_channels or max(ch[0], min(self.nc, 100))
