...
PHASE1_VARIANTS = ("B1", "M0", "M1", "M2", "M3")
...
_ALLOWED: dict[str, frozenset[str]] = {
    "root": frozenset({"schema_version", "pipeline_name", "artifacts_root", "environment", "dataset", "model", "training", "pipeline", "variants"}),
    "environment": frozenset({"python", "torch", "cuda", "ultralytics", "faster_coco_eval"}),
    "dataset": frozenset({"source", "split_ratios", "class_names", "seed", "minimum_ball_count"}),
    "model": frozenset({"source_weights", "imgsz", "nc", "scale", "source_weights_sha256", "official_model_yaml_sha256", "official_default_yaml_sha256"}),
    ...
    "pipeline": frozenset({"max_attempts", "device", "systemd_unit_prefix"}),
}
...
class Phase1Config:
    ...
    def minimal_mapping(cls) -> dict[str, Any]:
        return {
            ...
            "model": {
                "source_weights": "../original/weight/yolo11m.pt",
                "source_weights_sha256": "d5ffc1a674953a08e11a8d21e022781b1b23a19b730afc309290bd9fb5305b95",
    ...
    def from_mapping(cls, raw: Mapping[str, Any]) -> Self:
        ...
        for section in ("environment", "dataset", "model", "training", "pipeline"):
