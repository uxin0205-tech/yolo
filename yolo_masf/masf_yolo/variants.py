...
_VARIANTS = {
    ...
    "P3M": VariantDefinition("P3M", (3, 5, 7), 1.0, "identity", "mfam"),
    "SP2": VariantDefinition("SP2", (), 0.0, "identity"),
...
ADDITIONAL_VARIANTS = ("P3M", "SP2")
TRAINED_VARIANTS = ("B1", "M7", "M0", "M1", "M2", "M3", *ADDITIONAL_VARIANTS)
EVALUATED_MODELS = ("B0", *TRAINED_VARIANTS, "SP2P")
SELECTION_CANDIDATES = ("M2", "M3")


def sp2p_variant_id(selected_partial: str) -> str:
    if selected_partial not in SELECTION_CANDIDATES:
